...
public class Example3 {
    ...
    public static void main(String[] args) {
        ...
        sort(objects, new Comparator<Person>() {
            @Override
            public int compare(Person o1, Person o2) {
                return Integer.compare(o1.getAge(), o2.getAge());
            }
        });
        sort(objects, new PhysicalObjectByWeightComparator());
        System.out.println(objects);
    ...
    private static class PhysicalObjectByWeightComparator implements Comparator<PhysicalObject>{
